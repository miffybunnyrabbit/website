...
export const logos: readonly LogoEntry[] = [
  { name: "Canva", asset: "canva.svg", status: "retain", permission: "pending", alt: "Canva" },
  { name: "Google", asset: "google.svg", status: "retain", permission: "pending", alt: "Google" },
  { name: "13SICK", asset: "13sick.svg", status: "retain", permission: "pending", alt: "13SICK" },
  { name: "BCG", asset: "bcg.svg", status: "retain", permission: "pending", alt: "BCG" },
  { name: "CommBank", asset: "commbank.svg", status: "retain", permission: "pending", alt: "CommBank" },
  { name: "Australia Post", asset: "australia-post.svg", status: "retain", permission: "pending", alt: "Australia Post" },
  { name: "eftpos", asset: "eftpos.svg", status: "retain", permission: "pending", alt: "eftpos" },
  { name: "Sydney Airport", asset: "sydney-airport.svg", status: "retain", permission: "pending", alt: "Sydney Airport" },
  { name: "Macquarie", asset: "macquarie.svg", status: "retain", permission: "pending", alt: "Macquarie" },
  { name: "Neara", asset: "neara.svg", status: "retain", permission: "pending", alt: "Neara" },
  { name: "Filecoin", asset: "filecoin.svg", status: "retain", permission: "pending", alt: "Filecoin" },
  { name: "Veyor", asset: "veyor.svg", status: "retain", permission: "pending", alt: "Veyor" },
  { name: "Ferovinum", asset: "ferovinum.svg", status: "retain", permission: "pending", alt: "Ferovinum" },
  { name: "Agonics", asset: "agonics.svg", status: "retain", permission: "pending", alt: "Agonics" },
  { name: "Spec", asset: "spec.svg", status: "retain", permission: "pending", alt: "Spec" },
  { name: "Jubi", asset: "jubi.svg", status: "retain", permission: "pending", alt: "Jubi" },
  { name: "Xylo", asset: "xylo.svg", status: "retain", permission: "pending", alt: "Xylo" },
  { name: "Origami", asset: "origami.svg", status: "retain", permission: "pending", alt: "Origami" },
