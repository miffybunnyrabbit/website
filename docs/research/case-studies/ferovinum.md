...
**Plan references:** §9.2 (research direction), §17.8 R-007.
...
Concept stage. [VERIFY: entry reference point].
...
- Operating model: [RESEARCH: operating-model contribution, if any]
- Fundraising/capital: Helped anchor early fundraising.
