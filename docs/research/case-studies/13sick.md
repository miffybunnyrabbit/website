...
[RESEARCH: current-state reference, if any may be cited].
...
- Operating model: Applied systems thinking to the operating model.
- Fundraising/capital: [RESEARCH: capital contribution, if any]
...
AUD, shown as A$ per the claims methodology (D-001).
