...
FROM CONCEPT TO A LIVE AUTOMATED-LEVERAGE PROTOCOL
...
- Technology: Built the protocol engineering behind the automated positions (owner-stated, 2026-08-18).
- Commercial: Supported the launch into the wider DeFi market (owner-stated, 2026-08-18).
- Operating model: [RESEARCH: operating-model contribution]
...
Pending — client approval of the description required.
